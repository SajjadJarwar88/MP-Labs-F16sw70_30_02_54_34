...
public class MainActivity extends AppCompatActivity {
    UserDefinedBroadcast userdefine_broadcast;
    TextView textView;
    Button msg;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userdefine_broadcast= new UserDefinedBroadcast();
        setContentView(R.layout.activity_main);
        msg=findViewById(R.id.btn_msg);
        IntentFilter intentFilter= new IntentFilter("com.example.sajja.broadcast_receivers.custominent");
